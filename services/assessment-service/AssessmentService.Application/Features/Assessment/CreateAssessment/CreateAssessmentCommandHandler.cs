...
namespace AssessmentService.Application.Features.Assessment.CreateAssessment
{
    public class CreateAssessmentCommandHandler : ICommandHandler<CreateAssessmentCommand, int>
    {
        ...
        {
            // validation
            var validationResult = await _createAssessmentCommandValidator.ValidateAsync(assessmentCommand, cancellationToken);
            ...
            try
            {
                ...
                await _redisService.RemoveAsync($"assessments:all");
